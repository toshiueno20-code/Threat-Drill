...
class SecurityAuditReportGenerator:
    ...
    def generate_pdf_report(
        ...
        # タイトル
        story.append(Paragraph("Threat Drill", self.title_style))
        ...
        story.append(Spacer(1, 0.5 * inch))
        footer_text = (
            f"Report generated by Threat Drill on {datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S UTC')}"
        )
        story.append(
            Paragraph(
                footer_text,
    ...
    def generate_html_summary(self, audit_result: SecurityAuditResult) -> str:
        ...
        html = f"""
## Threat Drill Security Audit Report
...
*Report generated by Threat Drill on {audit_result.scan_timestamp}*
"""
